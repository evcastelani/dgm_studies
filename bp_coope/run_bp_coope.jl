include("bp_coope.jl")
include("coope_intersection_spheres.jl")
#include("visualizar_solucao.jl")
using MAT #pacote para leitura de arquivos do matlab
function run_bp_coope(probname::String)#probname corresponde ao nome do problema que estamos testando
curr_dir=pwd()
cd("../examples/")
