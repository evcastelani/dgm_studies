...
function bp_coope(M::Array{Float64,2},D::Array{Float64,2},n::Int64)
...
(P1,P2)=coope_intersection_spheres([x[1,:] x[2,:] x[3,:]],r,3,3)  #P1 e P2 sao os pontos de intersecao obtidos pelas esferas
...
while (i<n+1)
   ...
   (P1,P2)=coope_intersection_spheres([x[i-3,:] x[i-2,:] x[i-1,:]],r,3,3) #calcula a intersecao das três esferas obtendo o par de pontos
